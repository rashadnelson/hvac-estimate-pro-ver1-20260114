            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">
                  By accessing or using HVAC Estimate Pro, you agree to be bound by these Terms of Service. 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">
                  HVAC Estimate Pro provides a web-based platform for creating, managing, and sending 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Access to HVAC Estimate Pro requires a paid subscription:
                </p>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">
                  All content, features, and functionality of HVAC Estimate Pro are owned by us and are 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">
                  HVAC Estimate Pro is provided "as is" without warranties of any kind. We are not liable 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">
                  ...
                  <a href="mailto:support@hvacestimatepro.dev" className="text-accent hover:underline">
