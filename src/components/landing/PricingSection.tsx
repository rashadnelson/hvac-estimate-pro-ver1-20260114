      ...
      <div className="container">
        ...
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <h2 className="font-display text-3xl font-extrabold tracking-tight sm:text-4xl md:text-5xl text-[#1A1A1A]">
            ...
            <span className="block text-[#F97316]">No surprises.</span>
          </h2>
            ...
            return (
              <div
                ...
                className={`relative rounded-2xl p-8 flex flex-col ${
                  tier.highlighted
                    ? "border-2 border-[#F97316] bg-white shadow-xl"
              ...
              >
                ...
                {tier.badge && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <span className="inline-flex items-center gap-1 rounded-full bg-[#F97316] px-4 py-1.5 text-sm font-bold text-white">
                      {tier.badge}
                    </span>
                  </div>
                )}
                ...
                <ul className="space-y-3 mb-8 flex-grow">
                  {tier.features.map((feature) => (
                    <li key={feature.name} className="flex items-center gap-3">
                      {feature.included ? (
                        <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[#F97316]/10 text-[#F97316] flex-shrink-0">
